...
const ContactDetail = ({ updateContact, updateImage }) => {
    ...
    return ( <
        ...
        <
        Link to = { '/contacts' }
        className = 'link' > < i className = 'bi bi-arrow-left' > < /i> Back to list</Link >
        <
        ...
        className = 'btn' > < i className = 'bi bi-cloud-upload' > < /i> Change Photo</button >
        <
        /div> <
        /div> <
        ...
        ref = { inputRef }
        onChange = {
            (event) => udpatePhoto(event.target.files[0]) }
        name = 'file'
        accept = 'image/*' / >
        <
        /form> <
